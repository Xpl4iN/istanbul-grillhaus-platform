        ...
        <main className="min-h-screen bg-[#f5f0e8] p-8 md:p-16 text-[#1a1008] font-sans">
            <div className="max-w-2xl mx-auto space-y-8">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-sm">Der Schutz Ihrer pers�nlichen Daten ist uns ein besonderes Anliegen. Wir behandeln Ihre personenbezogenen Daten vertraulich und entsprechend der gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerkl�rung.</p>
                </section>
